...
{
	public abstract class CreateNodeAction : ActionBase
	{
		protected CreateNodeAction (UMLDiagram owningDiagram) : base (owningDiagram)
		{
			Position = new MonoUML.DI.Point (0, 0);
		}

		public MonoUML.DI.Point Position;
	}
}
