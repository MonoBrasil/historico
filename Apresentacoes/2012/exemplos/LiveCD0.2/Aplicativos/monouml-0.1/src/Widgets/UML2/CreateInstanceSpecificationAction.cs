...
{
	public class CreateInstanceSpecificationAction : CreateNodeAction
	{
		public CreateInstanceSpecificationAction (UMLDiagram owningDiagram) : base (owningDiagram)
		{
		}

		public override string Name
		{
			get { return "Create an Instance Specification"; }
		}

		public override void Execute ()
		{
			CreateInstanceSpecificationAction.Execute (_owningDiagram, base.Position);
		}
